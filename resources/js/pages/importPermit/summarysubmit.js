...
document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('importerName').textContent = importerData.name;
        document.getElementById('importerPhoneno').textContent = importerData.phone;
        document.getElementById('simpAdd').textContent = impAddrs;
        document.getElementById('sexpName').textContent = exporterData.name;
        document.getElementById('sexpfonno').textContent = exporterData.fonno;
        document.getElementById('sexpAddress').textContent = exporterData.address;
        document.getElementById('sexpCountry').textContent = exporterData.country;
        ...
        document.getElementById('sentryp').textContent = permitDetails.entrypoint;
        ...
        targetTable.insertAdjacentHTML('beforeend', `
            <tr>
            <td>${index + 1}</td>
            <td>${rowData[1] || ''}</td>
            <td>${rowData[2] || ''}</td>
        ...
        document.querySelector('#summaryTable3').scrollIntoView({ behavior: 'smooth' });
