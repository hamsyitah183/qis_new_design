...
// auto-logging out the user. Only active when on an inspection application page.
$(document).ready(function () {
    const isInspectionPage = window.location.pathname.includes('inspection_certificates_application');
