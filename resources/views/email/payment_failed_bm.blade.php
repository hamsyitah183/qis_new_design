                            ...
                            <tr>
                                <td style="padding: 40px 50px;">
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 12px;">
                                        <tr>
                                            <td style="background-color: #ffebee; border-radius: 4px; padding: 4px 10px;">
                                                <span style="font-size: 11px; font-weight: 700; color: #dc3545; text-transform: uppercase; letter-spacing: 1px;">
                                                    &#9679; PEMBAYARAN GAGAL
                                                </span>
                                            </td>
                                        </tr>
                                    ...
                                    <div style="font-size: 14px; line-height: 1.8; color: #444444;">
                                        <p style="margin-top: 0;">Dukacita dimaklumkan bahawa pembayaran untuk pesanan anda (<strong>{{ $orderNumber }}</strong>) telah gagal.</p>
                                        ...
                                        <div style="background-color: #f8f9fa; border: 1px solid #eeeeee; border-radius: 6px; padding: 20px; margin: 20px 0;">
                                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="color: #444444; font-size: 14px; line-height: 1.8;">
                                                <tr>
                                                    <td width="130" style="font-weight: 600;">Rujukan FPX:</td>
                                                    <td>{{ $fpxReference }}</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td style="font-weight: 600;">Jenis Permohonan:</td>
                                                ...
                                                <tr>
                                                    <td style="font-weight: 600;">E-mel:</td>
                                                    <td>{{ $email }}</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td style="font-weight: 600;" valign="top">Permit:</td>
                                                    <td>
                                        ...
                                        <div style="margin-top: 24px; text-align: center;">
                                            <a href="{{ url('/') }}" style="display: inline-block; background-color: #dc3545; color: #ffffff; text-decoration: none; padding: 12px 24px; border-radius: 6px; font-weight: 600;">Kembali ke halaman utama</a>
                                        </div>
                                    </div>
