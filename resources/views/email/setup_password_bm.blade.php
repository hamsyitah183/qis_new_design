...
<head>
    ...
    <title>Permohonan Tetapan Kata Laluan</title>
</head>
                            ...
                            <tr>
                                <td style="padding: 40px 50px;">
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 12px;">
                                        <tr>
                                            <td style="background-color: #e0f2f1; border-radius: 4px; padding: 4px 10px;">
                                                <span style="font-size: 11px; font-weight: 700; color: #00695c; text-transform: uppercase; letter-spacing: 1px;">
                                                    &#9679; SELAMAT DATANG
                                                </span>
                                            </td>
                                        </tr>
                                    ...
                                    <div style="font-size: 14px; line-height: 1.8; color: #444444;">
                                        <p style="margin-top: 0;">Helo,</p>
                                        <p>Satu akaun telah dicipta untuk anda di sistem QIS. Sebelum anda boleh log masuk, anda perlu menetapkan kata laluan anda. Sila klik butang di bawah untuk meneruskan.</p>

                                        <div style="margin-top: 30px; margin-bottom: 30px; text-align: center;">
                                            <a href="{{ $setupUrl ?? '#' }}" style="display: inline-block; background-color: #2e7d32; color: #ffffff; text-decoration: none; padding: 12px 28px; border-radius: 6px; font-weight: 600;">Tetapkan Kata Laluan</a>
                                        </div>
                                        
                                        <p style="color: #6c757d; font-size: 13px;">Jika anda tidak memohon akaun ini, sila hubungi pasukan sokongan kami. Pautan ini hanya boleh digunakan sekali.</p>
                                    </div>
