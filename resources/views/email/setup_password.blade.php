...
<head>
    ...
    <title>Set Up Password Request</title>
</head>
                            ...
                            <tr>
                                <td style="padding: 40px 50px;">
                                    ...
                                    <div style="font-size: 14px; line-height: 1.8; color: #444444;">
                                        ...
                                        <p>An account has been created for you in the QIS system. Before you can log in, you need to set up your password. Please click the button below to proceed.</p>

                                        <div style="margin-top: 30px; margin-bottom: 30px; text-align: center;">
                                            <a href="{{ $setupUrl ?? '#' }}" style="display: inline-block; background-color: #2e7d32; color: #ffffff; text-decoration: none; padding: 12px 28px; border-radius: 6px; font-weight: 600;">Set Up Password</a>
                                        </div>
                                        
                                        <p style="color: #6c757d; font-size: 13px;">If you did not request this account, please contact our support team. This link can only be used once.</p>
                                    </div>
