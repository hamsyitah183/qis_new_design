            ...
            <td align="center" style="padding: 40px 20px;">
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; width: 100%;">
                    ...
                    <tr>
                        ...
                        @else
                            <p style="font-size: 18px; font-weight: bold; color: #2e7d32;">Sistem QIS</p>
                        @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" style="padding-top: 20px;">
                            <p style="margin: 0; font-size: 11px; color: #6c757d;">© {{ date('Y') }} QIS. Hak cipta
                                terpelihara.</p>
                        </td>
                    </tr>
                </table>
