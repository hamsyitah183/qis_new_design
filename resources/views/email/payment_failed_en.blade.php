                            ...
                            <tr>
                                <td style="padding: 40px 50px;">
                                    ...
                                    <div style="font-size: 14px; line-height: 1.8; color: #444444;">
                                        <p style="margin-top: 0;">Unfortunately, your order (<strong>{{ $orderNumber }}</strong>) payment has failed.</p>
                                        ...
                                        <div style="margin-top: 24px; text-align: center;">
                                            <a href="{{ url('/') }}" style="display: inline-block; background-color: #dc3545; color: #ffffff; text-decoration: none; padding: 12px 24px; border-radius: 6px; font-weight: 600;">Back to main page</a>
                                        </div>
                                    </div>
