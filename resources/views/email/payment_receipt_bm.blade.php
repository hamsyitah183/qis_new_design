                            ...
                            <tr>
                                <td style="padding: 40px 50px;">
                                    ...
                                    <div style="font-size: 14px; line-height: 1.8; color: #444444;">
                                        <p style="margin-top: 0;">Pembayaran untuk pesanan anda (<strong>{{ $orderNumber }}</strong>) telah berjaya.</p>
                                        ...
                                        <div style="margin-top: 24px; text-align: center;">
                                            <a href="{{ url('/') }}" style="display: inline-block; background-color: #2e7d32; color: #ffffff; text-decoration: none; padding: 12px 24px; border-radius: 6px; font-weight: 600;">Kembali ke halaman utama</a>
                                        </div>
                                    </div>
