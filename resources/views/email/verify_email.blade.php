                            ...
                            <tr>
                                <td style="padding: 40px 50px;">
                                    ...
                                    <div style="font-size: 14px; line-height: 1.8; color: #444444;">
                                        <p style="margin-top: 0;">Hello{{ isset($user) && $user->fullname ? ' ' . $user->fullname : (isset($name) && $name ? ' ' . $name : '') }},</p>
                                        <p>Thank you for registering an account with the QIS System. To complete your registration and secure your account, please verify your email address by clicking the button below.</p>

                                        <div style="margin-top: 30px; margin-bottom: 30px; text-align: center;">
                                            <a href="{{ $url ?? '#' }}" style="display: inline-block; background-color: #2e7d32; color: #ffffff; text-decoration: none; padding: 12px 28px; border-radius: 6px; font-weight: 600;">Verify Email Address</a>
                                        </div>
                                        
                                        <p style="color: #6c757d; font-size: 13px;">If you did not create an account, no further action is required.</p>
                                    </div>
