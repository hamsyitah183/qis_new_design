...
<head>
    ...
    <title>Permohonan Tetapan Semula Kata Laluan</title>
</head>
                            ...
                            <tr>
                                <td style="padding: 40px 50px;">
                                    ...
                                    <div style="font-size: 14px; line-height: 1.8; color: #444444;">
                                        ...
                                        <p>Anda baru-baru ini telah memohon untuk menetapkan semula kata laluan bagi akaun QIS anda. Sila klik butang di bawah untuk meneruskan.</p>

                                        <div style="margin-top: 30px; margin-bottom: 30px; text-align: center;">
                                            <a href="{{ $resetUrl ?? '#' }}" style="display: inline-block; background-color: #2e7d32; color: #ffffff; text-decoration: none; padding: 12px 28px; border-radius: 6px; font-weight: 600;">Tetapkan Semula Kata Laluan</a>
                                        </div>
                                        
                                        <p style="color: #6c757d; font-size: 13px;">Jika anda tidak memohon tetapan semula kata laluan, tiada tindakan lanjut diperlukan. Pautan ini hanya boleh digunakan sekali.</p>
                                    </div>
