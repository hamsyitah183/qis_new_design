                ...
                <div class="card-body">
                    <div class="row gy-3">
                        ...
                        <div class="col-xl-6">
                            ...
                            <span
                                class="text-muted">{{ $document->created_at ? $document->created_at->format('d M Y H:i') : '—' }}</span>
                        </div>
                        <div class="col-xl-6">
                            <strong data-en="Updated At" data-bm="Dikemaskini Pada">Updated At:</strong>
                            <span
                                class="text-muted">{{ $document->updated_at ? $document->updated_at->format('d M Y H:i') : '—' }}</span>
                        </div>
                        <div class="col-xl-12">
