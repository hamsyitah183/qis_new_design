                ...
                @if($isPublic)
                    ...
                    <li class="slide has-sub {{ $isPublicAppActive ? 'open active' : '' }}">
                        <a href="javascript:void(0);" class="side-menu__item">
                            ...
                            <span class="side-menu__label" style="white-space: pre-line; line-height: 1.2;" data-en="Application&#10;List" data-bm="Senarai&#10;Permohonan">Application&#10;List</span>
                    ...
                    @if($canSeeUserManagement)
                        ...
                        <li class="slide has-sub {{ $isUserManagementActive ? 'open active' : '' }}">
                            <a href="javascript:void(0);" class="side-menu__item">
                                ...
                                <span class="side-menu__label" style="white-space: pre-line; line-height: 1.2;" data-en="User&#10;Management" data-bm="Pengurusan&#10;Pengguna">User&#10;Management</span>
                            </a>
                            <ul class="slide-menu child1">
                                ...
                                @if($isSuperadmin)
                                    <li class="slide {{ $currentRoute === 'internal.internal.role' ? 'active' : '' }}">
                                        <a href="{{ route('internal.internal.role') }}" class="side-menu__item" data-en="Role and Permission" data-bm="Peranan dan Kebenaran">Role and Permission</a>
                                    </li>
                                    <li class="slide">
                                        <a href="{{ route('internal.boundary.list') }}" class="side-menu__item" data-en="Boundary Officer" data-bm="Pegawai Sempadan">Boundary Officer</a>
                                    </li>
                                @endif
                            </ul>
                        </li>
                    ...
                    @if($canViewImporter || $canViewExporter)
                        <li class="slide has-sub {{ $isImporterExporterActive ? 'open active' : '' }}">
                            <a href="javascript:void(0);" class="side-menu__item">
                                <i class="ri-arrow-down-s-line side-menu__angle"></i>
                                <i class="ti ti-user side-menu__icon"></i>
                                <span class="side-menu__label" style="white-space: pre-line; line-height: 1.2;" data-en="Importer &amp;&#10;Exporter" data-bm="Pengimport &amp;&#10;Pengeksport">Importer &amp;&#10;Exporter</span>
                            </a>
                            <ul class="slide-menu child1">
