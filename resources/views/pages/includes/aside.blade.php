    ...
    <div class="main-sidebar" id="sidebar-scroll">
        <nav class="main-menu-container nav nav-pills flex-column sub-open">
            ...
            @php
                ...
                // ── Permission checks ────────────────────────────────────
                $canViewDashboard        = $internalUser?->can('view dashboard') ?? false;
                $canReadApplication      = $internalUser?->can('read application') ?? false;
                $canApproveApplication   = $internalUser?->can('approve application') ?? false;
                $canEditApplication      = $internalUser?->can('edit application') ?? false;
                ...
                $canViewOrdersInvoices   = $internalUser?->can('view orders invoices') ?? false;
                $canManageRolePermission = $internalUser?->can('manage role and permission') ?? false;
                ...
                // ── Importer/Exporter visibility ────────────────────────
                $canSeeImporterExporter = $canViewImporter || $canViewExporter;
                ...
                // ── Special: Consignment list only for Sipitang branch or superadmin/admin ──
                $isSipitang = ($internalUser?->branch ?? '') === 'Sipitang';
                $canViewConsignmentList = $isSipitang || $isSuperadmin || $isAdmin;
            @endphp
            ...
            <ul class="main-menu">
                ...
                {{-- ── PUBLIC SECTION ──────────────────────────────────────────────── --}}
                @if ($isPublic)
                    <li class="slide__category"><span class="category-name" data-en="Application" data-bm="Permohonan">Application</span></li>
                    ...
                    <li class="slide {{ Str::contains($currentRoute, 'vehicles') ? 'open active' : '' }}">
                        <a href="{{ route('vehicles.index') }}" class="side-menu__item">
                            <i class="bi bi-truck side-menu__icon"></i>
                            <span class="side-menu__label" data-en="Vehicle List" data-bm="Senarai Kenderaan">Vehicle List</span>
                        </a>
                    </li>
                    ...
                    <li class="slide has-sub {{ $isPublicAppActive ? 'open active' : '' }}">
                        <a href="javascript:void(0);" class="side-menu__item">
                            ...
                            <span class="side-menu__label" style="white-space: pre-line; line-height: 1.2;"
                                  data-en="Application&#10;List" data-bm="Senarai&#10;Permohonan">Application&#10;List</span>
                            <i class="ri-arrow-down-s-line side-menu__angle"></i>
                        </a>
                        <ul class="slide-menu child1">
                            <li class="slide">
                                <a href="{{ route('public.verifyapplication') }}" class="side-menu__item" id="toReviewCount">
                                    <span data-bm="Untuk Disemak" data-en="To Review">To Review</span>
                                </a>
                            </li>
                            <li class="slide">
                            ...
                            <li class="slide">
                                <a href="{{ route('public.showallapplicationlist') }}" class="side-menu__item" data-en="Import Permit List" data-bm="Permit Import">Import Permit</a>
                            </li>
                            <li class="slide">
                                <a href="{{ route('public.showallinspectionlist') }}" class="side-menu__item" data-en="Inspection Certificate List" data-bm="Sijil Pemeriksaan">Inspection Certificate</a>
                            </li>
                            <li class="slide">
                                <a href="{{ route('public.showallconsignmentlist') }}" class="side-menu__item" data-en="Consignment Certificate List" data-bm="Sijil Konsainan">Consignment Certificate</a>
                            </li>
                        </ul>
                    </li>
                @endif
                ...
                @if ($isInternal)
                    ...
                    {{-- Application --}}
                    @if ($canReadApplication || $canApproveApplication || $canEditApplication)
                        <li class="slide__category"><span class="category-name" data-en="Application" data-bm="Permohonan">Application</span></li>
                        ...
                        <li class="slide has-sub {{ $isApplicationActive ? 'open active' : '' }}">
                            ...
                            <ul class="slide-menu child1">
                                <li class="slide side-menu__label1"><a href="javascript:void(0)" data-en="Application List" data-bm="Senarai Permohonan">Application List</a></li>

                                {{-- Import Permit --}}
                                <li class="slide {{ $currentRoute === 'internal.application.list' ? 'active' : '' }}">
                                    <a href="{{ route('internal.application.list') }}" class="side-menu__item" id="importPermitCount" data-en="Import Permit" data-bm="Permit Import">Import Permit</a>
                                </li>
                                ...
                                {{-- Consignment Certificate – branch/role restricted --}}
                                @if ($canViewConsignmentList)
                    ...
                    @if ($canSeeUserManagement)
                        <li class="slide__category"><span class="category-name" data-en="User" data-bm="Pengguna">User</span></li>
                        ...
                        <li class="slide has-sub {{ $isUserManagementActive ? 'open active' : '' }}">
                            <a href="javascript:void(0);" class="side-menu__item">
                                ...
                                <span class="side-menu__label" style="white-space: pre-line; line-height: 1.2;"
                                      data-en="User&#10;Management" data-bm="Pengurusan&#10;Pengguna">User&#10;Management</span>
                            </a>
                            <ul class="slide-menu child1">
                                <li class="slide side-menu__label1"><a href="javascript:void(0)" data-en="Users" data-bm="Pengguna">Users</a></li>

                                @if ($canReadPublicUser)
                                    <li class="slide {{ $currentRoute === 'internal.public.list' ? 'active' : '' }}">
                                        <a href="{{ route('internal.public.list') }}" class="side-menu__item" data-en="Public Users" data-bm="Pengguna Awam">Public Users</a>
                                    </li>
                                @endif

                                @if ($canReadInternalUser)
                                    <li class="slide {{ $currentRoute === 'internal.internal.list' ? 'active' : '' }}">
                                        <a href="{{ route('internal.internal.list') }}" class="side-menu__item" data-en="Internal Users" data-bm="Pengguna Dalaman">Internal Users</a>
                                    </li>
                                @endif

                                @if ($canApprovePublicUser)
                                    <li class="slide {{ $currentRoute === 'internal.public.verification.list' ? 'active' : '' }}">
                                        <a href="{{ route('internal.public.verification.list') }}" class="side-menu__item" id="verificationCount" data-en="User Verification" data-bm="Pengesahan Pengguna">User Verification</a>
                                    </li>
                                @endif

                                @if ($canReadActivityLog)
                                    <li class="slide {{ $currentRoute === 'internal.activity_logs' ? 'active' : '' }}">
                                        <a href="{{ route('internal.activity_logs') }}" class="side-menu__item" data-en="Activity Log" data-bm="Log Aktiviti">Activity Log</a>
                                    </li>
                                @endif

                                @if ($canManageRolePermission)
                                    <li class="slide {{ $currentRoute === 'internal.internal.role' ? 'active' : '' }}">
                                        <a href="{{ route('internal.internal.role') }}" class="side-menu__item" data-en="Role &amp; Permission" data-bm="Peranan &amp; Kebenaran">Role &amp; Permission</a>
                                    </li>
                                @endif
                            </ul>
                        </li>
                    ...
                    {{-- Importer & Exporter --}}
                    @if ($canSeeImporterExporter)
                        <li class="slide has-sub {{ $isImporterExporterActive ? 'open active' : '' }}">
                            <a href="javascript:void(0);" class="side-menu__item">
                                <i class="ri-arrow-down-s-line side-menu__angle"></i>
                                <i class="ti ti-user side-menu__icon"></i>
                                <span class="side-menu__label" style="white-space: pre-line; line-height: 1.2;"
                                      data-en="Importer &amp;&#10;Exporter" data-bm="Pengimport &amp;&#10;Pengeksport">Importer &amp;&#10;Exporter</span>
                            </a>
                            <ul class="slide-menu child1">
                                <li class="slide side-menu__label1"><a href="javascript:void(0)" data-en="Importer &amp; Exporter" data-bm="Pengimport &amp; Pengeksport">Importer &amp; Exporter</a></li>

                                @if ($canViewImporter)
                                    <li class="slide {{ $currentRoute === 'internal.importer.list' ? 'active' : '' }}">
                                        <a href="{{ route('internal.importer.list') }}" class="side-menu__item" data-en="Importer List" data-bm="Senarai Pengimport">Importer List</a>
                                    </li>
                                @endif

                                @if ($canViewExporter)
                                    <li class="slide {{ $currentRoute === 'internal.exporter.list' ? 'active' : '' }}">
                                        <a href="{{ route('internal.exporter.list') }}" class="side-menu__item" data-en="Exporter List" data-bm="Senarai Pengeksport">Exporter List</a>
                                    </li>
                                @endif
                            </ul>
                        </li>
                    ...
                    {{-- Vehicle List (superadmin/admin only) --}}
                    ...
                    @if ($isSuperadmin)
                        <li class="slide {{ Str::contains($currentRoute, 'documents') ? 'open active' : '' }}">
                            <a href="{{ route('internal.documents.index') }}" class="side-menu__item">
                                ...
                                <span class="side-menu__label" data-en="Document List" data-bm="Senarai Dokumen">Document List</span>
                            </a>
                        </li>
                    @endif
                    ...
                    @if ($canManageSettings)
                        <li class="slide__category"><span class="category-name" data-en="Misc" data-bm="Pelbagai">Misc</span></li>
                        ...
                        <li class="slide has-sub {{ Str::startsWith($currentRoute, 'internal.') ? 'open active' : '' }}">
                            <a href="javascript:void(0);" class="side-menu__item">
                                ...
                                <span class="side-menu__label" style="line-height:1.3rem">
                                    <span data-en="System Configuration" data-bm="Konfigurasi Sistem">System <br> Configuration</span>
                                </span>
                            </a>
                            <ul class="slide-menu child1">
                                <li class="slide side-menu__label1"><a href="javascript:void(0)" data-en="Misc" data-bm="Pelbagai">Misc</a></li>
                                <li class="slide {{ $currentRoute === 'internal.controlpanel' ? 'active' : '' }}">
                                    <a href="{{ url('/internal/control_panel') }}" class="side-menu__item" data-en="Control Panel" data-bm="Panel Kawalan">Control Panel</a>
                                </li>
                                <li class="slide">
                                    <a href="{{ url('/internal/permit_condition') }}" class="side-menu__item" data-en="Permit Item" data-bm="Item Permit">Permit Item</a>
                                </li>
                                <li class="slide">
                                    <a href="{{ url('/internal/consignment_condition') }}" class="side-menu__item" data-en="Consignment Item" data-bm="Item Konsainan">Consignment Item</a>
                                </li>
                                <li class="slide {{ $currentRoute === 'internal.state-district-management' ? 'active' : '' }}">
                                    <a href="{{ route('internal.state-district-management') }}" class="side-menu__item" data-en="State &amp; District Management" data-bm="Pengurusan Negeri &amp; Daerah">State &amp; District Management</a>
                                </li>
                    ...
                    {{-- Order --}}
                    @if ($canViewOrdersInvoices)
                        <li class="slide__category"><span class="category-name" data-en="Order" data-bm="Pesanan">Order</span></li>
