<div class="tab-pane fade border-0 p-0 active show" id="order-tab-pane" role="tabpanel" aria-labelledby="order-tab-pane"
    ...
    <div class="p-3">
        ...
        <div class="row">
            <div class="col-xl-9 cursor-pointer mb-3">
                <div class="card custom-card card-style-6 border shadow-sm mb-xl-0 type-element">
                    <label class="card-body p-3" for="address1">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3 type-div">
                            <div class="d-flex align-items-center gap-2">
                                <h6
                                    class="fs-16 mb-0 fw-semibold border border-container border-3 p-3 rounded-3 d-flex justify-content-center icon-box">
                                    <i class="bx bx-user fs-2 mb-2 text-primary icon"></i>
                                </h6>
            ...
            <div class="col-xl-9 cursor-pointer">
                <div class="card custom-card card-style-6 border shadow-sm mb-0 type-element">
    ...
    <div class="p-3 border-top border-block-start-dashed d-sm-flex justify-content-end">
        <button class="btn btn-primary" id="nextToPersonalTab" type="button">
            Continue
