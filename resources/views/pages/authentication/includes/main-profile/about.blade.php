    ...
    <li class="list-group-item p-3">
        ...
        <div class="text-muted">
            ...
            <p class="mb-3">
                ...
                <span class="fw-medium text-default" data-en="Phone :" data-bm="Telefon :">Phone : </span>
            ...
            @if ($user['type'] === 'internal')
                <p class="mb-0 branch-info">
                    ...
                    <span class="fw-medium text-default" data-en="Branch :" data-bm="Cawangan :">Branch : </span>
