...
@push('style')
    <style>
        /* Same styles as verify email blade */
        .auth-page-wrapper {
            min-height: 100vh;
            display: flex;
            align-items: center;
        ...
        @media (max-width: 991.98px) {
            ...
            .auth-card-visual { display: none; }
            .auth-card-form { padding: 24px 18px; }
        }
        @media (max-width: 575.98px) {
            .auth-page-wrapper { padding: 0; }
            .auth-card { border-radius: 0; min-height: 100vh; box-shadow: none; }
            .auth-card-form { padding: 18px 14px; }
            ...
            <div class="auth-card-visual d-none">
                ...
                <div>
                    <div class="visual-steps">
                        <span class="step-dot active" data-step-dot="password-setup-tab"></span>
                    </div>
                    <div class="visual-caption-block active" data-caption-for="password-setup-tab">
                        <span class="step-tag" data-en="Setup" data-bm="Persediaan">Setup</span>
                        <h5 data-en="Check Your Email" data-bm="Semak E-mel Anda">Check Your Email</h5>
                        <p data-en="We've sent a password setup link to your email address. Click the link to create a new password."
                           data-bm="Kami telah menghantar pautan persediaan kata laluan ke alamat e-mel anda. Klik pautan untuk mencipta kata laluan baharu.">
                            We've sent a password setup link to your email address. Click the link to create a new password.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="auth-card-form">
                <div class="auth-form-inner">
                    <div class="text-center">
                        ...
                        <div class="p-2 mt-4">
                            <h4 data-bm="Sediakan Kata Laluan Anda" data-en="Set Up Your Password">Set Up Your Password</h4>
                            <p>
                                <span data-bm="Kami telah menghantar pautan persediaan kata laluan ke" data-en="We have sent a password setup link to">We have sent a password setup link to</span>
                            ...
                            <div class="mt-4 d-flex justify-content-center gap-2 flex-wrap">
                                <form method="POST" action="{{ route('password.setup.resend') }}" id="resendSetupForm">
                                    @csrf
                                    <input type="hidden" name="email" value="{{ $email ?? '' }}">
                                    <button type="submit" class="btn-auth-primary" data-bm="Hantar Semula Pautan" data-en="Resend Link">Resend Link</button>
                                </form>
                    ...
                    <div class="mt-5 text-center">
                        <p>
                            ...
                            <a href="#" class="fw-medium text-primary" data-bm="Hantar Semula" data-en="Resend" onclick="document.getElementById('resendSetupForm').submit(); return false;"> Resend </a>
                        </p>
                    </div>
                </div>
            </div>
