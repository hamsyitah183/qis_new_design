    ...
    <div class="row justify-content-center gy-3">
        <div class="col-xl-6">
            <div class="register-page ipa-card h-100">
                ...
                <div class="row gy-3">
                    <div class="col-xl-12">
                        @if ($inspectionDocuments->isEmpty())
                            <p class="text-muted">No document requirements configured for this application type.</p>
                        @else
                            <div class="d-flex flex-column gap-3" id="inspection-document-list">
                                @foreach ($inspectionDocuments as $doc)
                                    <div class="border rounded p-3 inspection-doc-block"
