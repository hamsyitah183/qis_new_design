            ...
            <div class="modal-body">
                <div class="row gy-4 mb-3 p-4">
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                        <label for="itemSelect" class="form-label" data-en="Item" data-bm="Item">Item </label><a style="color:red"> * </a>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                        <label for="itemMeasure" class="form-label" data-en="Measurement Unit" data-bm="Unit Ukuran">Measurement Unit</label><a style="color:red"> * </a>
