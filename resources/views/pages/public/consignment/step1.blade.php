                            ...
                            <div class="dz-default dz-message">
                                <button class="dz-button p-5 border w-100 border-radius" type="button">
                                    ...
                                    <span data-en="Drop files here to upload"
                                        data-bm="Jatuhkan fail di sini untuk dimuat naik">Drop files here to
                                        upload</span>
                                </button>
...
<x-modal id="addVehicleModal" title="Add Vehicle">
    <form id="addVehicleForm">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <label for="addValidFrom" class="form-label" data-en="Valid From" data-bm="Berkuatkuasa Dari">Valid From</label>
                <input type="date" id="addValidFrom" name="addValidFrom" class="form-control">
            </div>
            <div class="col-md-6">
                <label for="addValidUntil" class="form-label" data-en="Valid Until" data-bm="Berkuatkuasa Hingga">Valid Until</label>
        ...
        @slot('footer')
            ...
            <button type="button" id="addVehicleBtn" class="btn btn-primary ipa-btn-primary" data-en="Save Vehicle" data-bm="Simpan Kenderaan">Save Vehicle</button>
        @endslot
    </form>
</x-modal>
