        ...
        <div class="col-xl-12">
            <div class="register-page ipa-card h-100">
                <div class="ipa-card-header">
                    ...
                    <h6 data-en="Consignment Details" data-bm="Butiran Konsainan">Consignment Details <a style="color:red"> * </a>
                ...
                <div class="row gy-3 mb-3">
                    <div class="col-xl-6">
                        <label for="eta" class="form-label" data-en="Estimated Time Arrival" data-bm="Anggaran Waktu Ketibaan">Estimated Time Arrival <a style="color:red"> * </a></label>
