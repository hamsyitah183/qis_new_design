                                                        ...
                                                        <div class="register-page">
                                                            ...
                                                            <div class="row gy-3">
                                                                ...
                                                                <div class="col-xl-12">
                                                                    ...
                                                                    <input type="text" class="form-control " id="impname" name="impname" value="{{ $application->importer->fullname }}" disabled>
                                                                </div>
                                                                <div class="col-xl-12">
                                                                    <label for="impfonno" class="form-label">Phone No</label>
                                                                    <input type="text" class="form-control " id="impfonno" name="impfonno" value="{{ $application->importer->phone_number }}" disabled>
                                                                </div>
                                                                <div class="col-xl-12">
                                                                    <label for="impaddress" class="form-label">Address</label>
                                                                    <input type="text" class="form-control mb-2" id="impaddress1" name="impaddress1" value="{{ $application->importer->address_1 }}" disabled>
                                                                    <input type="text" class="form-control " id="impaddress2" name="impaddress2" value="{{ $application->importer->address_2 }}" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="register-page">
                                                            ...
                                                            <div class="row gy-3">
                                                                ...
                                                                <div class="col-xl-12">
                                                                    ...
                                                                    <input type="text" class="form-control " id="expname" name="expname" value="{{ $application->exporter->name }}" disabled>
                                                                </div>
                                                                <div class="col-xl-12">
                                                                    <label for="expfonno" class="form-label">Phone No</label>
                                                                    <input type="text" class="form-control " id="expfonno" name="expfonno" value="{{ $application->exporter->phone_no }}" disabled>
                                                                </div>
                                                                <div class="col-xl-12">
                                                                    <label for="expaddress" class="form-label">Address</label>
                                                                    <input type="text" class="form-control mb-2" id="expaddress1" name="expaddress1" value="{{ $application->exporter->address }}" disabled>
                                                                    <!-- <input type="text" class="form-control " id="expaddress2"  name="expaddress2"> -->
                                                                </div>
                                                                <div class="col-lg-12">
                                                                    <label for="expcountry" class="form-label">Country</label>
                                                                    <input type="hidden" class="form-control mb-2" id="expcountryCode" value="{{ $application->exporter->country }}" name="expcountryCode" >
                                                                    <input type="text" class="form-control" id="expcountry" value="{{ $application->exporter->country }}" name="expcountry" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="register-page">
                                                            ...
                                                            <div class="row gy-3 mb-3">
                                                                <div class="col-xl-6">
                                                                    ...
                                                                    <input type="text" class="form-control " id="eta" name="eta" value="{{ \Carbon\Carbon::parse($application->eta)->format('d/m/Y') }}" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="row gy-3">
                                                                <div class="col-xl-6">
                                                                    <label for="trnptType" class="form-label">Transport Type</label>
                                                                    <select class="form-select" id="trnptType" name="trnptType" data-route="{{ route('public.getEntryPoint') }}" disabled>
                                                                ...
                                                                <div class="col-xl-6">
                                                                    ...
                                                                    <select class="form-select" id="entryPoint" name="entryPoint" disabled>
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table  text-nowrap">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                <td class="w-25">
                                                                                    <span class="d-block fw-semibold text-end">&nbsp;&nbsp;&nbsp;&nbsp; Address</span>
                                                                                </td>
                                                                                <td class="w-10">:</td>
                                                                                <td class="text-start text-muted" id="simpAdd">
                                                                                    {{ $application->importer->address_1 }} , {{ $application->importer->address_2 }} , {{ $application->importer->postcode }}, {{ $application->importer->district }}
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="w-25">
                                                                            ...
                                                                            <tr>
                                                                                <td class="w-25">
                                                                                    <span class="d-block fw-semibold text-end">&nbsp;&nbsp;&nbsp;&nbsp; Country</span>
                                                                                </td>
                                                                                <td class="w-10">:</td>
                                                            ...
                                                            <div class="row d-flex justify-content-center">
                                                                <div class="col-lg-10">
                                                                    @if ($application->importer_id == auth()->id())
                                                                        <div class="row justify-content-center" >
                                                                            <div class="col-auto d-flex gap-3">
                                                                                <button id="rejectAppl" type="button" class="btn btn-md btn-warning">Reject Application</button>
                                                                                <button id="verifyAppl" type="button" class="btn btn-md btn-info">Verify Application</button>
                                                                            </div>
                                                                        </div>
                                                                    @else
                                                                            ...
                                                                            <div class="text-center p-4">
                                                                                <span class="avatar avatar-xl avatar-rounded bg-warning-transparent svg-warning">
                                                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
                                                                                        <rect width="256" height="256" fill="none"></rect>
                                                                                        <circle cx="128" cy="128" r="96" opacity="0.2"></circle>
                                                                                        <line x1="128" y1="80" x2="128" y2="136" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"></line>
