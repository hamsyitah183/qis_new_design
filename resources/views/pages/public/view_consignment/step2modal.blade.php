    ...
    <form class="modal-dialog modal-fullscreen">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header ">
                <h5 class="modal-title" id="addExporterModalLabel" data-bm="Tambah Konsainan" data-en="Add Consignment">
                    Add Consignment
                </h5>
            ...
            <div class="modal-body">
                <div class="row gy-4 mb-3 p-4">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <label for="certificateNo" class="form-label" data-bm="No Sijil (MyGAP atau myOrganic)" data-en="Certificate No (MyGAP or myOrganic)">Certificate No (MyGAP or myOrganic)</label>
            ...
            <div class="modal-footer">
                ...
                <button id="saveBtn" type="submit" class="btn btn-primary">
                    <i class="bx bx-save me-1"></i> <span data-bm="Tambah Item" data-en="Add Item">Add Item</span>
                </button>
            </div>
            <!-- </form> -->
