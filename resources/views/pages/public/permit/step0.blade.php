            ...
            <div class="register-page">
                ...
                <div class="row gy-3">
                    ...
                    <div class="col-xl-12">
                        ...
                        <input type="text" class="form-control " id="impname" name="impname" value="{{ Auth::user()->fullname ?? '' }}" disabled>
                    </div>
                    <div class="col-xl-12">
                        <label for="impfonno" class="form-label">Phone No</label>
                        <input type="text" class="form-control " id="impfonno" name="impfonno" value="{{ Auth::user()->phone_number ?? '' }}" disabled>
                    </div>
                    <div class="col-xl-12">
                        <label for="impaddress" class="form-label">Address</label>
                        <input type="text" class="form-control mb-2" id="impaddress1" name="impaddress1" value="{{ Auth::user()->address_1 ?? '' }}" disabled>
                        <input type="text" class="form-control " id="impaddress2" name="impaddress2" value="{{ Auth::user()->address_2 ?? '' }}" disabled>
                    </div>
                </div>
            </div>
        </div>
