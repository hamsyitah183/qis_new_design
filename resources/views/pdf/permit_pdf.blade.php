...
<head>
    ...
    <style>
        ...
        .schedule-table {
            ...
            margin-top: 0;
            /* remove any margin above the table */
        }
...
<body>
    ...
    <table style="width:100%; border-collapse:collapse; margin-bottom:5px; table-layout: fixed; word-wrap: break-word;">
        ...
        <tr>
            ...
            <td style="padding:2px 5px; border-bottom:1px dotted #000; width:75%;">
                <span class="variable-value"
                    style="display:block; font-size:9pt; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;">
        ...
        <tr>
            ...
            <td style="padding:2px 5px; border-bottom:1px dotted #000; width:75%;">
                <span class="variable-value"
                    style="display:block; font-size:8pt; line-height:1.1; white-space:normal; word-wrap:break-word;">
                    {{ strtoupper(
                        ($importer['address_1'] ?? '') .
                            ', ' .
                            ($importer['address_2'] ?? '') .
    ...
    <ol class="conditions-list">
        ...
        <li>
            This permit is valid until <span class="underline-dots" style="width: 150px;"> <span
                    class="variable-value">{{ $validityDate ?? '' }}</span></span> for one consignment only.
        </li>
        <li>
            The consignment must be accompanied by a Phytosanitary Certificate or a statement from the official Plant
            Protection Service of the country of origin bearing the following certificate:
            <ol class="sub-list">
                <li>
                    (a) Treatment
    ...
    <table class="schedule-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="height:70px;"><span
                        class="variable-value">{{ ($permits['quantity'] ?? '-') . ' ' . ($permits['unit_measurement'] ?? '') }}</span>
                </td>
