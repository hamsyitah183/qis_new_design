...
var Pe = (t, r, o) =>
    r in t
        ? Re(t, r, { enumerable: !0, configurable: !0, writable: !0, value: o })
        : (t[r] = o);
var R = (t, r, o) => Pe(t, typeof r != "symbol" ? r + "" : r, o);
const y = document.getElementById("sidebar");
let W = document.querySelector(".main-content");
...
class Ge {
    constructor(r, o) {
        ...
        R(this, "reference", null);
        R(this, "popperTarget", null);
        this.init(r, o);
    }
    init(r, o) {
        (this.reference = r),
            ...
            document.addEventListener(
                "click",
                (i) => this.clicker(i, this.popperTarget, this.reference),
                !1
            );
...
class He {
    constructor() {
        R(this, "subMenuPoppers", []);
        this.init();
    }
    init() {
        Me.forEach((r) => {
            this.subMenuPoppers.push(new Ge(r, r.lastElementChild)),
                this.closePoppers();
        });
    }
    togglePopper(r) {
...
const T = (t, r = 300) => {
    ...
    Le = (t, r = 300) => {
        ...
        var d = s.getBoundingClientRect(),
            ...
            m = d.right + u,
            f = d.left - u;
        a.getAttribute("dir") == "rtl"
            ? f < 0 ||
              (s.closest("ul").classList.contains("force-left") &&
                  m < window.innerWidth)
                ? t.classList.add("force-left")
                : t.classList.remove("force-left")
            : m > window.innerWidth ||
              (s.closest("ul").classList.contains("force-left") && f > 0)
            ? t.classList.add("force-left")
            : (f < 0, t.classList.remove("force-left"));
    },
    Ae = (t, r = 300) => {
                ...
                o
                    ...
                    .forEach((l) => {
                        (l.nextElementSibling.style.display === "block" ||
                            window.getComputedStyle(l.nextElementSibling)
                                .display === "block") &&
                            T(l.nextElementSibling);
                    }),
                Ae(t.nextElementSibling);
        }
    });
});
We.forEach((t) => {
...
(() => {
    ...
    (qe = document.querySelector(".sidemenu-toggle")),
        qe.addEventListener("click", S);
...
function S() {
    ...
    if (window.innerWidth >= 992) {
        if (r === "vertical") {
            switch (
                (y.removeEventListener("mouseenter", w),
                y.removeEventListener("mouseleave", L),
                y.removeEventListener("click", G),
                W.removeEventListener("click", H),
                document
                    .querySelectorAll(".main-menu li > .side-menu__item")
                    .forEach((a) => a.removeEventListener("click", F)),
                t.getAttribute("data-vertical-style"))
            ) {
                case "closed":
                    ...
                    t.removeAttribute("data-nav-style"),
                        t.getAttribute("data-toggled") === "icon-overlay-close"
                            ...
                            ? (localStorage.getItem("xintralayout") ||
                              ...
                              y.addEventListener("mouseenter", w),
                              y.addEventListener("mouseleave", L))
                            : (y.removeEventListener("mouseenter", w),
                              y.removeEventListener("mouseleave", L));
                    break;
                case "icontext":
                    ...
                    if (
                        ...
                        a &&
                            ...
                            a.nextElementSibling
                                ? a.nextElementSibling.classList.add(
                                      "double-menu-active"
                                  )
                                : document
                                      .querySelector("html")
                ...
                case "detached":
                    ...
                    break;
                case "default":
                    _(), t.removeAttribute("data-toggled");
                    break;
            }
            switch (t.getAttribute("data-nav-style")) {
                ...
                case "menu-hover":
                    t.getAttribute("data-toggled") === "menu-hover-closed"
                        ? (t.removeAttribute("data-toggled"), k())
                        : (t.setAttribute("data-toggled", "menu-hover-closed"),
                          h());
                    break;
                case "icon-click":
                ...
                case "icon-hover":
                    t.getAttribute("data-toggled") === "icon-hover-closed"
                        ? (t.removeAttribute("data-toggled"), k())
                        : (t.setAttribute("data-toggled", "icon-hover-closed"),
                          h());
                    break;
            }
        }
...
function De() {
    ...
    t.setAttribute("data-nav-style", "menu-click"),
        ...
        S(),
        t.getAttribute("data-nav-layout") === "vertical" && k();
}
function Oe() {
    let t = document.querySelector("html");
    t.setAttribute("data-nav-style", "menu-hover"),
        ...
        document.querySelectorAll(".slide.has-sub").forEach((o) => {
            o.addEventListener("mouseenter", Ke),
                o.addEventListener("mouseleave", Je);
        }),
        S(),
        t.getAttribute("data-toggled") === "menu-hover-closed" && h();
}
function Ue() {
    let t = document.querySelector("html");
                ...
                if ((o.closest("ul:not(.main-menu)"), l)) {
                    if (
                        ...
                        i.classList.add("open", "active"),
                            ...
                            Array.from(i.children[1].children).map((a) => {
                                a.classList.contains("active") &&
                                    (a.children[1].style.display = "block");
                            });
                    }
                    l.classList.contains("child1") && Le(l),
...
let P = document.querySelector(".slide.has-sub.open.active");
P &&
    document.querySelector(".child3 .side-menu__item.active") &&
    ((P.closest("ul.slide-menu").style.display = "block"),
    P.closest("ul.slide-menu")
    ...
    P.closest("ul.slide-menu")
        ...
        .classList.add("open"));
var we;
(we = document.querySelector(".slide.has-sub.active .slide.has-sub.active")) ==
    null || we.classList.add("open");
function h() {
...
function $e() {
    ...
    function o() {
        ...
        l.forEach((a, s) => {
            a.classList.contains("is-expanded") == !0 &&
                a.classList.remove("is-expanded");
        }),
            i.forEach((a, s) => {
                a.classList.contains("open") == !0 &&
                    (a.classList.remove("open"), (a.style.display = "none"));
            });
    }
    z(),
        t.addEventListener("click", () => {
            let l = document.querySelector(".main-menu"),
                ...
                s = Math.ceil(
                    Number(
                        window.getComputedStyle(l).marginRight.split("px")[0]
                    )
                ),
                d = i.offsetWidth;
            l.scrollWidth > i.offsetWidth
                ? document.querySelector("html").getAttribute("dir") !== "rtl"
                    ? a < 0 && !(Math.abs(a) < d)
                        ? ((l.style.marginRight = 0),
                          (l.style.marginLeft =
                              Number(l.style.marginLeft.split("px")[0]) +
                              Math.abs(d) +
                              "px"),
                    ...
                    ? ((l.style.marginLeft = 0),
                      (l.style.marginRight =
                          Number(l.style.marginRight.split("px")[0]) +
                          Math.abs(d) +
                          "px"),
                      r.classList.remove("d-none"))
                    : (s >= 0,
                ...
                : ((document.querySelector(".main-menu").style.marginLeft =
                  ...
                  (document.querySelector(".main-menu").style.marginRight =
                      "0px"),
                  t.classList.add("d-none"));
            let u = document.querySelector(".main-menu > .slide.open"),
        ...
        r.addEventListener("click", () => {
            let l = document.querySelector(".main-menu"),
                ...
                d = l.scrollWidth - i.offsetWidth,
                u = i.offsetWidth;
            l.scrollWidth > i.offsetWidth &&
                (document.querySelector("html").getAttribute("dir") !== "rtl"
                    ? Math.abs(d) > Math.abs(a) &&
                      ((l.style.marginRight = 0),
                      Math.abs(d) > Math.abs(a) + u ||
                          ((u = Math.abs(d) - Math.abs(a)),
                    ...
                    : Math.abs(d) > Math.abs(s) &&
                      ((l.style.marginLeft = 0),
                      Math.abs(d) > Math.abs(s) + u ||
                          ((u = Math.abs(d) - Math.abs(s)),
                          r.classList.add("d-none")),
                      (l.style.marginRight =
                          Number(l.style.marginRight.split("px")[0]) -
                          Math.abs(u) +
            ...
            let m = document.querySelector(".main-menu > .slide.open"),
                f = document.querySelector(".main-menu > .slide.open >ul");
...
function z() {
    ...
    let t = document.querySelector(".main-menu"),
        ...
        i = Math.ceil(
            Number(window.getComputedStyle(t).marginLeft.split("px")[0])
        ),
        a = Math.ceil(
    ...
    if (
        ...
        document.querySelectorAll(".slide.has-sub.open > ul").forEach((g) => {
            let b = g,
                C = document.documentElement;
            const A = b.closest("li");
            var q = A.getBoundingClientRect(),
                I = b.getBoundingClientRect().width,
                B = q.right + I,
                x = q.left - I;
            C.getAttribute("dir") == "rtl"
                ? (g.classList.contains("child1") && q.left < 0 && h(),
                  x < 0 ||
                  (A.closest("ul").classList.contains("force-left") &&
                      B < window.innerWidth)
                      ? b.classList.add("force-left")
                      : b.classList.remove("force-left"))
                : (g.classList.contains("child1") &&
                      q.right > window.innerWidth &&
                      h(),
                  B > window.innerWidth ||
                  (A.closest("ul").classList.contains("force-left") && x > 0)
                      ? b.classList.add("force-left")
                      : (x < 0, b.classList.remove("force-left")));
        });
        let m = document.querySelector(".slide-menu.active.force-left");
        m &&
            (document.querySelector("html").getAttribute("dir") != "rtl"
                ? m.getBoundingClientRect().right < innerWidth
                    ? m.classList.remove("force-left")
                    : m.getBoundingClientRect().left < 0 &&
                ...
                : m.getBoundingClientRect().left -
                      ((d = m.parentElement.closest(".slide-menu")) == null
                          ? void 0
                          : d.clientWidth) -
                  ...
                  (document.documentElement.getAttribute("data-nav-style") ==
                      ...
                      window.innerWidth > 992) &&
                  m.classList.remove("force-left")),
            document.querySelectorAll(".main-menu .has-sub ul").forEach((g) => {
                if (je(g)) {
    ...
    document.querySelector("html").getAttribute("dir") !== "rtl"
        ...
        : (t.scrollWidth > r.offsetWidth &&
              ...
              o.classList.remove("d-none"),
              l.classList.add("d-none")),
          a == 0 ? o.classList.add("d-none") : o.classList.remove("d-none")),
        (i != 0 || a != 0) && o.classList.remove("d-none");
}
function je(t) {
    return window.getComputedStyle(t).display != "none";
}
...
function Ke(t) {
    ...
    if (
        ...
        var i = u.getBoundingClientRect(),
            a = l.getBoundingClientRect().width,
            s = i.right + a,
            d = i.left - a;
        r.getAttribute("dir") == "rtl"
            ? d < 0 ||
              (u.closest("ul").classList.contains("force-left") &&
                  s < window.innerWidth)
                ? l.classList.add("force-left")
                : l.classList.remove("force-left")
            : s > window.innerWidth ||
              (u.closest("ul").classList.contains("force-left") && d > 0)
            ? l.classList.add("force-left")
            : (d < 0, l.classList.remove("force-left"));
    }
}
            ...
            (document.querySelector(".slide-menu") &&
                document.querySelectorAll(".slide-menu").forEach((i) => {
                    i.classList.contains("double-menu-active") &&
                        (i.classList.remove("double-menu-active"),
...
window.addEventListener("unload", () => {
    document.querySelector(".main-content").removeEventListener("click", h),
        window.removeEventListener("resize", E),
        document
            .querySelectorAll(".main-menu li > .side-menu__item")
            .forEach((o) => o.removeEventListener("click", F));
});
let Xe = () => {
...
(function () {
    document.querySelector("html"),
        (xe = document.querySelector(".main-content")),
...
function Ye() {
    ...
    (i = document.querySelector("#switcher-light-theme")),
        ...
        (d = document.querySelector("#switcher-full-width")),
        (g = document.querySelector("#switcher-menu-fixed")),
        (m = document.querySelector("#switcher-menu-scroll")),
        (f = document.querySelector("#switcher-header-fixed")),
        (u = document.querySelector("#switcher-header-scroll")),
        (b = document.querySelector("#switcher-header-light")),
        (C = document.querySelector("#switcher-header-dark")),
        ...
        (I = document.querySelector("#switcher-menu-light")),
        (B = document.querySelector("#switcher-menu-dark")),
        (x = document.querySelector("#switcher-menu-primary")),
        ...
        ($ = document.querySelector("#switcher-classic")),
        (j = document.querySelector("#switcher-modern")),
        (J = document.querySelector("#switcher-default-menu")),
        (ee = document.querySelector("#switcher-menu-click")),
        (te = document.querySelector("#switcher-menu-hover")),
        (re = document.querySelector("#switcher-icon-click")),
        (le = document.querySelector("#switcher-icon-hover")),
        (K = document.querySelector("#switcher-closed-menu")),
        (Q = document.querySelector("#switcher-icontext-menu")),
        (Y = document.querySelector("#switcher-icon-overlay")),
        (Z = document.querySelector("#switcher-double-menu")),
        (X = document.querySelector("#switcher-detached")),
        document.querySelector("#resetbtn"),
        (oe = document.querySelector("#switcher-primary")),
        (ce = document.querySelector("#switcher-primary1")),
        (ie = document.querySelector("#switcher-primary2")),
        (ae = document.querySelector("#switcher-primary3")),
        (ne = document.querySelector("#switcher-primary4")),
        (se = document.querySelector("#switcher-background")),
        (de = document.querySelector("#switcher-background1")),
        (ue = document.querySelector("#switcher-background2")),
        (me = document.querySelector("#switcher-background3")),
        (ye = document.querySelector("#switcher-background4")),
        (he = document.querySelector("#switcher-bg-img")),
        (ge = document.querySelector("#switcher-bg-img1")),
        (be = document.querySelector("#switcher-bg-img2")),
        (Se = document.querySelector("#switcher-bg-img3")),
        (ve = document.querySelector("#switcher-bg-img4")),
        (fe = document.querySelector("#reset-all")),
        (pe = document.querySelector("#switcher-loader-enable")),
        (ke = document.querySelector("#switcher-loader-disable")),
        oe.addEventListener("click", () => {
            localStorage.setItem("primaryRGB", "118, 71, 229"),
                c.style.setProperty("--primary-rgb", "118, 71, 229");
        }),
        ce.addEventListener("click", () => {
            localStorage.setItem("primaryRGB", "63, 75, 236"),
                c.style.setProperty("--primary-rgb", "63, 75, 236");
        }),
        ie.addEventListener("click", () => {
            localStorage.setItem("primaryRGB", "55, 125, 206"),
                c.style.setProperty("--primary-rgb", "55, 125, 206");
        }),
        ae.addEventListener("click", () => {
            localStorage.setItem("primaryRGB", "1, 159, 162"),
                c.style.setProperty("--primary-rgb", "1, 159, 162");
        }),
        ne.addEventListener("click", () => {
            localStorage.setItem("primaryRGB", "139, 149, 4"),
                c.style.setProperty("--primary-rgb", "139, 149, 4");
        }),
        ...
        x.addEventListener("click", () => {
            c.setAttribute("data-menu-styles", "color"),
        ...
        D.addEventListener("click", () => {
            c.setAttribute("data-menu-styles", "gradient"),
        ...
        A.addEventListener("click", () => {
            c.setAttribute("data-header-styles", "color"),
        ...
        q.addEventListener("click", () => {
            c.setAttribute("data-header-styles", "gradient"),
        ...
        J.addEventListener("click", () => {
            c.setAttribute("data-vertical-style", "default"),
                ...
                document.querySelectorAll(".main-menu>li.open").forEach((n) => {
                    n.classList.contains("active") ||
                        (n.classList.remove("open"),
                        (n.querySelector("ul").style.display = "none"));
                });
        }),
        ...
        X.addEventListener("click", () => {
            Ne(), localStorage.setItem("xintraverticalstyles", "detached");
        }),
        Q.addEventListener("click", () => {
            _e(), localStorage.setItem("xintraverticalstyles", "icontext");
        }),
        ...
        Z.addEventListener("click", () => {
            Fe(), localStorage.setItem("xintraverticalstyles", "doublemenu");
        }),
        ...
        o.addEventListener("click", () => {
            let n = document.querySelector(".main-content");
        ...
        r.addEventListener("click", () => {
            localStorage.setItem("xintrartl", !0),
                localStorage.removeItem("xintraltr"),
                Ze(),
                document.querySelector(".noUi-target") &&
                    (console.log("working"),
                    document.querySelectorAll(".noUi-origin").forEach((n) => {
                        n.classList.add("transform-none");
                    }));
        }),
        t.addEventListener("click", () => {
            localStorage.setItem("xintraltr", !0),
                localStorage.removeItem("xintrartl"),
                Ee(),
                document.querySelector(".noUi-target") &&
                    document.querySelectorAll(".noUi-origin").forEach((n) => {
                        n.classList.remove("transform-none");
                    });
        }),
        fe.addEventListener("click", () => {
            rt(),
                ...
                document
                    .querySelector("html")
                    .setAttribute("data-width", "fullwidth"),
                (document.querySelector("#switcher-menu-dark").checked = !0),
                document.querySelectorAll(".slide").forEach((n) => {
                    n.classList.contains("open") &&
                        !n.classList.contains("active") &&
...
function Ee() {
    ...
    document.querySelector("#style").href.includes("bootstrap.min.css") ||
        ...
        r.setAttribute(
            "href",
            "https://laravelui.spruko.com/xintra/build/assets/libs/bootstrap/css/bootstrap.min.css"
        ),
...
function et() {
    ...
    t.setAttribute("data-theme-mode", "dark"),
        ...
        localStorage.setItem("xintradarktheme", !0),
...
function rt() {
    let t = document.querySelector("html");
    localStorage.getItem("xintralayout") == "horizontal" &&
        ...
        Ee(),
        Be(),
        xe.removeEventListener("click", h),
        ...
        setTimeout(() => {
            document.querySelectorAll(".slide").forEach((r) => {
                r &&
                    document.querySelector(".child3 .side-menu__item.active") &&
...
function p() {
    if (
        (localStorage.getItem("xintradarktheme") &&
            (document.querySelector("#switcher-dark-theme").checked = !0),
        localStorage.getItem("xintralayout") === "horizontal"
            ? ((document.querySelector("#switcher-horizontal").checked = !0),
              (document.querySelector("#switcher-menu-click").checked = !0))
        ...
        localStorage.getItem("xintrartl")
            ? (document.querySelector("#switcher-rtl").checked = !0)
            : (document.querySelector("#switcher-ltr").checked = !0),
        localStorage.getItem("xintraHeader") === "light" &&
            (document.querySelector("#switcher-header-light").checked = !0),
        localStorage.getItem("xintraHeader") === "color" &&
            (document.querySelector("#switcher-header-primary").checked = !0),
        localStorage.getItem("xintraHeader") === "gradient" &&
            (document.querySelector("#switcher-header-gradient").checked = !0),
        localStorage.getItem("xintraHeader") === "dark" &&
            (document.querySelector("#switcher-header-dark").checked = !0),
        localStorage.getItem("xintraHeader") === "transparent" &&
            (document.querySelector("#switcher-header-transparent").checked =
                !0),
        localStorage.getItem("xintraMenu") === "light" &&
            (document.querySelector("#switcher-menu-light").checked = !0),
        localStorage.getItem("xintraMenu") === "color" &&
            (document.querySelector("#switcher-menu-primary").checked = !0),
        localStorage.getItem("xintraMenu") === "gradient" &&
            (document.querySelector("#switcher-menu-gradient").checked = !0),
        localStorage.getItem("xintraMenu") === "dark" &&
            (document.querySelector("#switcher-menu-dark").checked = !0),
        localStorage.getItem("xintraMenu") === "transparent" &&
            (document.querySelector("#switcher-menu-transparent").checked = !0),
        localStorage.getItem("xintrafullwidth") &&
            (document.querySelector("#switcher-full-width").checked = !0),
        localStorage.getItem("xintraboxed") &&
            (document.querySelector("#switcher-boxed").checked = !0),
        localStorage.getItem("xintraheaderscrollable") &&
            (document.querySelector("#switcher-header-scroll").checked = !0),
        localStorage.getItem("xintramenuscrollable") &&
            (document.querySelector("#switcher-menu-scroll").checked = !0),
        localStorage.getItem("xintraheaderfixed") &&
            (document.querySelector("#switcher-header-fixed").checked = !0),
        localStorage.getItem("xintramenufixed") &&
            (document.querySelector("#switcher-menu-fixed").checked = !0),
        localStorage.getItem("xintraclassic") &&
            (document.querySelector("#switcher-classic").checked = !0),
        localStorage.getItem("xintramodern") &&
            (document.querySelector("#switcher-modern").checked = !0),
        localStorage.xintraverticalstyles)
    )
        switch (localStorage.getItem("xintraverticalstyles")) {
            case "default":
                document.querySelector("#switcher-default-menu").checked = !0;
                break;
            case "closed":
    ...
    if (localStorage.xintranavstyles)
        switch (localStorage.getItem("xintranavstyles")) {
            case "menu-click":
                document.querySelector("#switcher-menu-click").checked = !0;
                break;
            case "menu-hover":
